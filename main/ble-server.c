...
static struct gatts_profile_inst gl_profile_tab[SERVER_PROFILE_NUM] = {
        [PROFILE_A_APP_ID] = {
    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT: {
            ...
            if (!param->write.is_prep){
                ...
                esp_log_buffer_hex(GATTS_TAG, uint8ToString(param->write.value, param->write.len), param->write.len);
